...
.factory('crudFactory', function($http, sharedProperties) {
    return {
        ...
        iemlvalid : function(input) {            
          ...
          return $http.post('http://parser.dev.metaml.net/ScriptParser/rest/iemlparser', 'iemltext='+encodeURIComponent(input));
        }, 

        parsetree : function(input) {            
          $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
          return $http.post('http://parser.dev.metaml.net/ScriptParser/rest/iemlparser/tree', 'iemltext='+encodeURIComponent(input));
        },

        iemltable : function(input) {            
          $http.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded";
          return $http.post('http://parser.dev.metaml.net/ScriptParser/rest/iemlparser/tables', 'iemltext='+encodeURIComponent(input));
        },
